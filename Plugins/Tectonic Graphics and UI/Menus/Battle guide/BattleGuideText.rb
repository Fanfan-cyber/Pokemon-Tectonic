...
def battleGuideCriticalHitsHash
    return {
        ...
        _INTL("Preventing Criticals") => _INTL("Certain abilities prevent critical hits against that Pokémon. The Lucky Chant effect protects their side from critical hits."),

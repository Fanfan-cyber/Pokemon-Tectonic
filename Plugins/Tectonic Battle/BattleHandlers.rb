...
module BattleHandlers
    ...
    def self.triggerDamageCalcUserAbility(ability, user, target, move, mults, baseDmg, type, aiCheck = false, backfire = false)
        DamageCalcUserAbility.trigger(ability, user, target, move, mults, baseDmg, type, aiCheck, backfire)
    end

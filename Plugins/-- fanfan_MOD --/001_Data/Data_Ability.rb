ABILITY_DATA = {
 #:ABOVEITALL        => { :desc => proc { _INTL("1111111") }, :details => proc { _INTL("2222222") }, },
  ...
  :GYRESPINNER      => { :desc => proc { _INTL("Upon entry, traps each opponent in a whirlpool for 1 turn.") }, },
  ...
  :SAPPER           => { :desc => proc { _INTL("Upon entry, traps each opponent in a sand tomb for 1 turn.") }, },

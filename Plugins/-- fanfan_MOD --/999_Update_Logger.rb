...
类R.O.W.E.的STAB系统，更加合理的本系加成算法（详情请参考v0.1.0更新日志）
...
9.更新了R.O.W.E.的STAB系统，现在单属性精灵的本系加成为1.5倍，多属性精灵的本系 加成为1.25倍
10.更新了新的技能威力属性加成机制，使用的技能与攻击方队伍里其他精灵具有相同的属性，就会有加成（每只单属性精灵加成20%，多属性精灵加成10%）
11.更新了新的技能威力属性削减机制，使用的技能与被击方队伍里其他精灵具有相同的属性，就会有削减（每只单属性精灵削减10%，多属性精灵削减5%）
12.

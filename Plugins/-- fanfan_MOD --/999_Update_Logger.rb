...
特性记录器功能，在和训练师的对战中，特性记录器会在对手出场时记录对手的特性
...
v0.0.9
1.修复了AI在某些情况下会错误的更新玩家精灵的特性的Bug
2.修复了Young Again在某些情况下会出现错误的退化贴图的Bug
3.修复了某些情况下查看战斗信息时特性显示错误的Bug
4.
...
10.取消密码nocopymon、copymonagain和adaptiveai
11.调换了战斗结束时完胜检测和是否将对方的队伍加载到战斗模拟器中的顺序
12.修复了当精灵拥有某些允许携带多个物品的特性时，但却无法携带多个物品的Bug
13.修复了Sticky Fingers允许携带多个物品的Bug（此为官方版本存在的Bug，已报告官方）
14.增加了特性记录器，在和训练师的对战中，特性记录器会在对手被打倒时记录对手的特性
15.现在特性记录器不会记录和战斗模拟器中对战的对手的特性
16.引入了特性自选模式，可以通过输入密码customabil开启
17.为特性记录器增加了特性自选功能，在特性自选模式下，可以在队伍菜单中的Modify（修改）中打开特性记录器，使用特性记录器中记录下的特性来修改精灵的主特性
18.特性自选模式开启后，对手训练师的队伍也会相应的变得更强
19.现在可以通过输入密码nocustomabil关闭特性自选功能，关闭后任何精灵的主特性都将不会再生效
20.现在在战斗中查看精灵的信息时将不会再使幻觉暴露
21.修改电脑的盒子数量为200
22.现在在开启火箭队模式时，将在完胜文本显示之后再询问玩家是否要获得对手的精灵
23.现在通过火箭队模式获得的精灵的主特性将会被清除
24.现在可以在精灵的概览页面按A键快速切换到精灵在图鉴中的特性页了
25.现在可以在精灵的概览页面按S键快速切换到精灵在图鉴中的种族值页了

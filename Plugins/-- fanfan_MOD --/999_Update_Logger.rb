...
濒死复活机制，濒死的精灵经过10回合之后会复活，但是每场战斗每只精灵只会触发1次，使用密码disablerevive关闭此机制
...
4.现在可以输入密码disablerevive来关闭濒死复活机制了，玩家可以自由选择是否开启濒死复活机制，默认为开启
5.现在可以输入密码battlerevive来重新开启濒死复活机制了
6.现在当战斗已经事实上无法获胜时，将会直接判负结束战斗了
7.现在受塔罗牌影响的战斗将不会再复制玩家的精灵了
8.翻译

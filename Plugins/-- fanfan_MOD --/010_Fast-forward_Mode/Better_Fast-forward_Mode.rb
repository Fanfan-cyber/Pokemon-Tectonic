...
#                                   Usage                                      #
#                                                                              #
# SPEEDUP_STAGES are the speed stages the game will pick from. If you click Q, #
...
# When the user clicks Q, it'll pick the next number in this array.
SPEEDUP_STAGES = [1, 2]
